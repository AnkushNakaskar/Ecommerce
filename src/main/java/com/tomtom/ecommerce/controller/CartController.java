...
public class CartController {
    ...
    public ResponseEntity<String> addProduct(@PathVariable Long userId, @RequestParam Long productId, @RequestParam Integer count) {
        try {
    ...
    public ResponseEntity<String> removeProduct(@PathVariable Long userId, @RequestParam Long productId, @RequestParam Integer count) {
        try {
